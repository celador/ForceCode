...
* autoRefresh: If autoCompile is on, and you're working in a resource-bundles folder, the staticResource will automatically compile and deploy to your org.  If autoRefresh is on, the currently active tab in Chrome will be refreshed.  This provides a "browsersync" experience without the overhead
