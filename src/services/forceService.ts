                ...
                if(Array.isArray(curSet)) {
                    curSet.forEach(key => {
                        ...
                        if(curFCFile) {
                            ...
                            if(curFCFile.compareDates(key.lastModifiedDate) || !vscode.workspace.getConfiguration('force')['checkForFileChanges'] || curMem.type === 'AuraDefinitionBundle' || curMem.type === 'LightningComponentBundle') {
